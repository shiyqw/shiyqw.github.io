...
[[official page](https://cloud.google.com/service-health)]
...
Role: Site Reliability Engineer III (2019-11 to 2023-03)<br>
...
*  Onboarded multiple Google Production services to VM-based test environments.
 ...
 The services onboarded including:
    ...
    *  _Name redacted_: A remote debug logging system
    *  _Name redacted_: A dynamic data push system
    *  _Name redacted_: A package management system
...
*  Simplified the configuration format. The new model is ~30% length of the old
 model
*  Migrate the backend to a different storage service (_Name redacted_)
